...
class Simulator:
    def __init__(self, num_samples, num_features, correlated, binarize, prefix=""):
        ...
        np.savez(
            f"simulation{prefix}.npz", X=self.X, y=self.y, featnames=self.featnames
        )
