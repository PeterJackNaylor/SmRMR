...
from . import association_measure as am
...
from .utils.checks import check_vector
...
class DCLasso(BaseEstimator, TransformerMixin):
    ...
    def get_association_measure(self):
        ...
        """
        f = am.pick_association_measure(self.measure_stat)
    ...
    def get_optimizer(self):
        if self.optimizer == "SGD":
            init, update, params = optimizers.sgd(self.learning_rate, **self.opt_kwargs)
